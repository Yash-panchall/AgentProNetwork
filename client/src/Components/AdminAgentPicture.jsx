...
function AdminAgentPicture(props) {
  ...
  useEffect(() => {
    const fetchProfileImage = async () => {
      try {
        const response = await fetch(`http://localhost:5000/api/admin/agents/profile-pic/${props.getId}`, {
          method: 'GET',
          headers: {
      ...
      <Container>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={8}>
            <AdminAgentForm getId = {props.getId}/>
          </Grid>
        </Grid>
      </Container>
    </Root>
...
export default AdminAgentPicture;