...
function AdminAgentForm(props) {
  ...
  useEffect(() => {
    ...
    const fetchAgentData = async () => {
      try {
        const response = await fetch(`http://localhost:5000/api/admin/agents/${props.getId}` , {
          method : "GET",
          headers : {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/admin/agents/update/${props.getId}`, {
        method: 'PATCH',
        headers: {
